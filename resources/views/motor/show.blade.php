...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
    <section class="relative bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white py-16 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-6 text-center">
            <h1 class="text-4xl md:text-5xl font-bold mb-4">{{ $motor->nama_motor }}</h1>
            <p class="text-xl text-gray-200">Detail lengkap motor pilihan Anda</p>
        </div>
    </section>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                <div class="grid lg:grid-cols-2 gap-0">
                    ...
                    <div class="p-8 lg:p-12 flex flex-col justify-between">
                        <div>
                            <div class="mb-8">
                                <h1 class="text-3xl lg:text-4xl font-bold text-gray-800 mb-4">{{ $motor->nama_motor }}</h1>
                            ...
                            <div class="grid grid-cols-2 gap-6 mb-8">
                                <div class="bg-gray-50 p-4 rounded-2xl">
                                    ...
                                    <div class="text-2xl font-bold text-gray-800">{{ $motor->tahun_motor }}</div>
                                </div>
                                ...
                                <div class="bg-gray-50 p-4 rounded-2xl">
                                    ...
                                    <div class="text-2xl font-bold text-gray-800">{{ number_format($motor->km_motor) }} KM</div>
                                </div>
                            </div>

                            <div class="mb-8">
                                <h3 class="text-xl font-bold text-gray-800 mb-4">Keunggulan Motor Ini</h3>
                        ...
                        <div class="space-y-4">
                            <a href="https://wa.me/087774559011?text=Halo,%20saya%20tertarik%20dengan%20{{ urlencode($motor->nama_motor) }}%20seharga%20Rp%20{{ number_format($motor->harga_motor) }}"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <form action="{{ route('motor.destroy', $motor->id) }}" method="POST" 
                                      onsubmit="return confirm('Yakin ingin menghapus motor ini?')" class="w-full">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
    ...
    <section class="bg-gray-50 py-16">
        <div class="max-w-7xl mx-auto px-6">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-800 mb-4">Motor Lainnya</h2>
                <p class="text-xl text-gray-600">Lihat koleksi motor lainnya yang mungkin Anda suka</p>
            </div>
            
            <div class="text-center">
                <a href="/" class="inline-flex items-center bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-blue-700 hover:to-blue-800 transform hover:scale-105 transition-all duration-200 shadow-lg">
                    <i class="fas fa-motorcycle mr-2"></i>Lihat Semua Motor
                </a>
            </div>
        </div>
    </section>
