...
@section('title', 'Tambah Motor - Baherindo Motor')
        ...
        <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed">
                    Lengkapi informasi motor yang akan dijual dengan detail yang akurat untuk menarik pembeli terbaik
                </p>
            </div>

            <!-- Form Container -->
            <div class="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 lg:p-12 border border-white/20">
                <form action="{{ route('motor.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                    @csrf
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <!-- Nama Motor -->
                        <div class="group">
                            <label for="nama_motor" class="block text-sm font-bold text-gray-700 mb-4">
                                <div class="flex items-center">
                                    <div class="bg-blue-100 p-3 rounded-xl mr-4">
                                        <i class="fas fa-motorcycle text-blue-600 text-lg"></i>
                                    </div>
                                    <div>
                                        <div class="text-lg">Nama Motor</div>
                                        <div class="text-xs text-gray-500 font-normal">Masukkan nama lengkap motor</div>
                                    </div>
                                </div>
                            </label>
                        ...
                        <!-- Harga Motor -->
                        <div class="group">
                            <label for="harga_motor" class="block text-sm font-bold text-gray-700 mb-4">
                                <div class="flex items-center">
                                    <div class="bg-green-100 p-3 rounded-xl mr-4">
                                        <i class="fas fa-tag text-green-600 text-lg"></i>
                                    </div>
                                    <div>
                                        <div class="text-lg">Harga Motor</div>
                        ...
                        <!-- Tahun Motor -->
                        <div class="group">
                            <label for="tahun_motor" class="block text-sm font-bold text-gray-700 mb-4">
                                <div class="flex items-center">
                                    <div class="bg-purple-100 p-3 rounded-xl mr-4">
                                        <i class="fas fa-calendar text-purple-600 text-lg"></i>
                                    </div>
                                    <div>
                                        <div class="text-lg">Tahun Motor</div>
                                        <div class="text-xs text-gray-500 font-normal">Tahun pembuatan motor</div>
                                    </div>
                                </div>
                            </label>
                        ...
                        <!-- KM Motor -->
                        <div class="group">
                            <label for="km_motor" class="block text-sm font-bold text-gray-700 mb-4">
                                <div class="flex items-center">
                                    <div class="bg-orange-100 p-3 rounded-xl mr-4">
                                        <i class="fas fa-tachometer-alt text-orange-600 text-lg"></i>
                                    </div>
                                    <div>
                                        <div class="text-lg">Kilometer Motor</div>
                    ...
                    <!-- Foto Motor -->
                    <div class="group">
                        <label for="gambar_motor" class="block text-sm font-bold text-gray-700 mb-6">
                            <div class="flex items-center">
                                <div class="bg-pink-100 p-3 rounded-xl mr-4">
                                    <i class="fas fa-camera text-pink-600 text-lg"></i>
                                </div>
                                <div>
                                    <div class="text-lg">Foto Motor</div>
                                    <div class="text-xs text-gray-500 font-normal">Upload foto terbaik motor Anda</div>
                                </div>
                            </div>
                        </label>
                        <div class="relative">
